...
def detect_intent_stream(project_id, session_id, audio_file, credentials, language_code):
    """
    ...
    def request_generator(audio_config, audio_file):
    ...
    requests = request_generator(audio_config, audio_file)
    ...
    print('Fulfillment text: {}'.format(query_result.fulfillment_text))
