...
class Ui_EditBlockDialog(object):
    def setupUi(self, EditBlockDialog):
        ...
        EditBlockDialog.resize(449, 552)
        ...
        self.rangeMinSpinBox.setEnabled(False)
        ...
        self.rangeMaxSpinBox.setEnabled(False)
        ...
        self.gridLayout_12.addWidget(self.rangeGroupBox, 0, 1, 1, 1)
