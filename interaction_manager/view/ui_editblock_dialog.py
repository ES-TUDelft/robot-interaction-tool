...
class Ui_EditBlockDialog(object):
    def setupUi(self, EditBlockDialog):
        ...
        self.gridLayout_18.addWidget(self.playlistComboBox, 0, 1, 1, 2)
        self.tracksComboBox = QtWidgets.QComboBox(self.musicGroupBox)
        self.tracksComboBox.setObjectName("tracksComboBox")
        self.gridLayout_18.addWidget(self.tracksComboBox, 1, 1, 1, 2)
    ...
    def retranslateUi(self, EditBlockDialog):
        ...
        self.label_23.setText(_translate("EditBlockDialog", "Play for (sec)"))
