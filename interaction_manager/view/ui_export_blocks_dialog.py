...
# Form implementation generated from reading ui file 'hre_ui/exportdialog.ui'
#
...
class Ui_ExportBlocksDialog(object):
    def setupUi(self, ExportBlocksDialog):
        ...
        ExportBlocksDialog.resize(454, 400)
        ...
        ExportBlocksDialog.setMinimumSize(QtCore.QSize(400, 300))
        ExportBlocksDialog.setMaximumSize(QtCore.QSize(500, 400))
